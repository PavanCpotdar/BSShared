                ...
                <CardContent>
                    <Grid container direction="row" alignItems="center" justify="center">
                        <div className={classes.root}>
                            <Grid className={classes.logoContainer} container direction="row" alignItems="center"
                                  justify="center">
                                <Logo/>
                            </Grid>
                            <Grid container direction="row" alignItems="center" className={classes.loginCardGrid}
                                  justify="center">
                                <Grid item>
                                ...
                                <Grid container direction="row" alignItems={'center'} spacing={4}>
                                    ...
                                    <Grid item>
                                        <Typography variant="subtitle2"
                                                    className={classes.forgotPasswordText}>{CONSTANTS.STRINGS_FORGOTPASSWORD}</Typography>
                                    </Grid>
                                </Grid>
                            </Grid>
